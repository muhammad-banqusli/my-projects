    ...
    return (
        <div className=" border-2 rounded-lg max-h-96 overflow-hidden">
            ...
            <div className="grid grid-cols-2 border-b-2 divide-x-2">
                ...
                <div className="grid grid-cols-4 place-content-center py-2 p-2 justify-items-center gap-2">{project.technologies.map(tech => <img key={tech.id} src={tech.src} alt={tech.title} title={tech.title} className="h-12 w-12 rounded-sm object-contain" />)}</div>
            </div>
